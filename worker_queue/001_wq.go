...
Output (timing/random-dependent)
 ...
 ... worker logs and Job id lines ...
 total time taken  10.00xxxx seconds
*/

/*
Code Explanation:
- Purpose: Worker queue with jobs/results channels and a fixed-size worker pool
- allocate enqueues N jobs with random nums; workers call digits and send Result; result goroutine prints
- wg.Wait waits for workers; results channel is closed after all workers finish
*/
